...
class AutopostSpecialFragment : Fragment() {

    companion object {
        fun newInstance(): AutopostSpecialFragment = AutopostSpecialFragment()
    }
    ...
    private suspend fun loadFbSession(icon: ImageView, check: ImageView) {
        ...
        try {
            ...
            withContext(Dispatchers.Main) {
                Glide.with(this@AutopostSpecialFragment)
                    .load(pic)
                    .circleCrop()
                    .into(icon)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_autopost_special, container, false)
    }
